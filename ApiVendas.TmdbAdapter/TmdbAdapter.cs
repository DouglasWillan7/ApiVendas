using ApiVendas.Domain.Adapters;
using ApiVendas.Domain.Exceptions;
using ApiVendas.Domain.Models;
using ApiVendas.TmdbAdapter.Clients;
using AutoMapper;
using Refit;
using System;
    ...
    internal class TmdbAdapter : ITmdbAdapter
    {
            ...
            Pesquisa pesquisa, string idioma)
        {
            try
            {
                ...
                TmdbSearchMoviesGetResult tmdbSearchMoviesGetResult;
